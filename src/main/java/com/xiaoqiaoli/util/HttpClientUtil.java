...
public class HttpClientUtil {
    ...
    private static ArrayList<NameValuePair> covertParams2NVPS(Map<String, Object> params) {
        ArrayList<NameValuePair> pairs = params.entrySet().stream().map(param -> new BasicNameValuePair(param.getKey(), param.getValue().toString())).collect(Collectors.toCollection(ArrayList::new));
